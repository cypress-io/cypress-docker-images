...
[cypress/browsers:node14.18.1-chrome](./node14.18.1-chrome) | `cypress/base:14.18.1` | `100` | `🚫` | `🚫`
[cypress/browsers:node14.18.1-chrome100](./node14.18.1-chrome100) | `cypress/base:14.18.1` | `100.0.4896.88` | `🚫` | `🚫` 
