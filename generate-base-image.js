...
let imageBase = 'base'
let extendFrom = 'buster'

if (slim) {
  outputFolder = path.join('base-slim', versionTag)
  imageBase = 'base-slim'
  extendFrom = 'buster-slim'
}
...
#   docker build -t cypress/${imageBase}:${versionTag} .
#
FROM node:${versionTag}-${extendFrom}
...
\`\`\`
FROM cypress/${imageBase}:${versionTag}
...
LOCAL_NAME=cypress/${imageBase}:${versionTag}
