...
[cypress/browsers:node16.14.2-slim-chrome103-ff102-edge-slim](./node16.14.2-slim-chrome103-ff102-edge-slim) | `cypress/base:16.14.2` | `103.0.5060.53` | `102.0.1` | `--edge` 
