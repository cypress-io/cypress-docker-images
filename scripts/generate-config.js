                  ...
                  steps:
                      - run:
                            ...
                            command: |
                                node --version
                                npm i cypress@latest
                                docker run -it -v $PWD:/e2e -w /e2e << parameters.imageName >> sh -c "./node_modules/.bin/cypress install && ./node_modules/.bin/cypress run --browser firefox"
                  ...
                  steps:
                      - run:
                            ...
                            command: |
                                node --version
                                npm i cypress@latest
                                docker run -it -v $PWD:/e2e -w /e2e << parameters.imageName >> sh -c "./node_modules/.bin/cypress install && ./node_modules/.bin/cypress run --browser edge"
