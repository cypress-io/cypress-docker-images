// creates new folder base/<version tag>-slim with Dockerfile and README file
...
if (!versionTag || !isStrictSemver(versionTag)) {
  console.error('expected version tag argument like "12.16.2"')
  process.exit(1)
}

const outputFolder = path.join('base', `${versionTag}-slim`)
...
#   docker build -t cypress/base:${versionTag}-slim .
#
FROM node:${versionTag}-buster-slim
...
\`\`\`
FROM cypress/base:${versionTag}-slim
...
LOCAL_NAME=cypress/base:${versionTag}-slim
